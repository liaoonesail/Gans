...
public class JuheDemo {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="0504986b3d49c03f9783d90a56aa8131";
    ...
    //2.发送短信
    public static String getRequest2(String mobile, String code){
        String result = "error";
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
            params.put("mobile",mobile);//接收短信的手机号码
            params.put("tpl_id","38892");//短信模板ID，请参考个人中心短信模板设置
    ...
    public static boolean send(String mobile, String code){
    	String result = getRequest2(mobile, code);
    	if("ok".equals(result)){
    		return true;
    	}else{
    		return false;
    ...
    public static void main(String[] args) {
    	System.out.println(send("15330322445", "841698"));
    }
